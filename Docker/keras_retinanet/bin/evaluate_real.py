...
def main(args=None):
    start_from_epoch = 2
    stop_at_epoch = 3
    print('starting from epoch ' + str(start_from_epoch), ' to epoch ', stop_at_epoch)
    ...
    compt = start_from_epoch
	
    while compt != stop_at_epoch + 1:
        print('Loading weights from epoch ' + str(compt) + '...')
        if compt < 10:
            weights = 'snapshots/resnet50_csv_0' + str(compt) + '.h5'
        else:
            weights = 'snapshots/resnet50_csv_' + str(compt) + '.h5'
        ...
        #Evaluate:
        history = prediction_model.evaluate_generator(
            generator=train_generator,
            steps=2893,
            workers=1
        )
        print('History of epoch ' + str(compt) + ':', history)
        compt = compt + 1
