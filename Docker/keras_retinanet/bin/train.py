...
def parse_args(args):
    ...
    parser.add_argument('--steps',           help='Number of steps per epoch.', type=int, default=11579)
...
def main(args=None):
    ...
    print('train_size, validation_size : ', train_generator.size(), validation_generator.size())
    ...
    if args.snapshot is not None:
        ...
        if start_from_epoch != 0:
            if start_from_epoch < 10:
                weights = 'snapshots/resnet50_csv_0' + str(start_from_epoch) + '.h5'
            else:
                weights = 'snapshots/resnet50_csv_' + str(start_from_epoch) + '.h5'
    ...
    # summarize history for regression loss
    ...
    # summarize history for classification_loss
    plt.plot(history.history['classification_loss'])
    plt.title('model classification_loss')
    plt.ylabel('classification_loss')
    plt.xlabel('epoch')
    plt.legend(['train'], loc='upper left')
    plt.show()
